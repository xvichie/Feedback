const buildPalette = (colorsList) => {
    ...
    for (let i = 0; i < orderedByColor.length; i++) {
        ...
        //!!!!!!!!!!!!!!!!!!!!console.log(document.createTextNode(hexColor));
...
const main = () => {
    ...
    fileReader.onload = () => {
        ...
        console.log(colors)
        document.getElementsByClassName('App')[0].style['border'] = '10px solid' + colors[colors.length - 2];
    };
    fileReader.readAsDataURL(file);
};

{/* <div className="Upload-Image-Test">
